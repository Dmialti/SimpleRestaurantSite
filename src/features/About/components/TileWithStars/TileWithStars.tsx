...
const TileWithStars: React.FC<TileWithStarsProps> = ({
  header,
  description,
}) => {
  return (
    <div className="flex flex-col items-center text-center min-w-0 w-full h-full p-8 gap-[9px] border border-border-default rounded-2xl text-text-default ">
